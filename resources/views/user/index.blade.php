...
<body>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        <a href="" class="navbar-brand d-flex align-items-center px-4 px-lg-5">
            <h2 class="m-0 text-primary"><i class='fas fa-archway' style='font-size:36px;color:rgb(0, 238, 255)'></i> DESA CANTIK</h2>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="courses.html" class="nav-item nav-link">Galeri</a>
                <div class="nav-item dropdown">
                    <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Halaman</a>
                    <div class="dropdown-menu fade-down m-0">
                        <a href="team.html" class="dropdown-item">Organisasi</a>
                        <a href="testimonial.html" class="dropdown-item">Kontribusi</a>
                        {{-- <a href="404.html" class="dropdown-item">404 Page</a> --}}
                    </div>
                </div>
                <a href="contact.html" class="nav-item nav-link">Contact</a>
            </div>
            <a href="/login" class="btn btn-primary py-4 px-lg-5 d-none d-lg-block">Login Admin<i class="fa fa-arrow-right ms-3"></i></a>
        </div>
    </nav>
    <!-- Navbar End -->
        ...
        <div class="container">
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Data Pendidikan</a>
                            <p>Data pendidikan terakhir penduduk SP2 Korano Jaya</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Data Penduduk</a>
                            <p>Data administrasi kependudukan penduduk SP2 Korano Jaya</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            ...
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Data Demografi</a>
                            <p>Data agama, golongan darah, dan etnis penduduk SP2 Korano Jaya</p>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <div class="service-item text-center pt-3">
                        <div class="p-4">
                            <i class='fas fa-3x fa-money-check-alt text-primary mb-4'></i>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Data Pekerjaan</a>
                            <p>Data pekerjaan penduduk SP2 Korano Jaya</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="owl-carousel testimonial-carousel position-relative">
                <div class="testimonial-item text-center">
                    ...
                    <h5 class="mb-0">Maimun</h5>
                    <p>Kepala BPS Teluk Bintuni</p>
        ...
        <div class="container py-5">
            <div class="row g-5">
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>SP2 Korano Jaya, Teluk Bintuni, Papua Barat</p>
                ...
                <div class="col-lg-3 col-md-6">
                    <h4 class="text-white mb-3">Kotak Saran</h4>
                    <p>Kirimkan pesan kepada kami untuk kemajuan desa</p>
                    <div class="position-relative mx-auto" style="max-width: 400px;">
                        <input class="form-control border-0 w-100 py-3 ps-4 pe-5" type="text" placeholder="Kirim saran">
